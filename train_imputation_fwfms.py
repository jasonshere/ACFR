...
test_model_label = ffm_test_df[target].values

# fit
impu_model = FwFM(linear_feature_columns_all, dnn_feature_columns_all, task="regression", **param)
